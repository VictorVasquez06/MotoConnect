...
class EventRepository implements IEventRepository {
  ...
  Future<void> updateAttendanceStatus(
    ...
    try {
      ...
      throw Exception(
        'Error al actualizar estado de asistencia: ${e.toString()}',
      );
    }
  }
  ...
  Future<List<EventParticipantModel>> getEventParticipantsDetailed(
    ...
    try {
      ...
      throw Exception(
        'Error al obtener participantes detallados: ${e.toString()}',
      );
    }
  }
  ...
  Future<List<Event>> getEventsByLocation({required String location}) async {
    try {
      ...
      throw Exception(
        'Error al obtener eventos por ubicación: ${e.toString()}',
      );
    }
  }
