...
class NavigationBloc extends Bloc<NavigationEvent, NavigationState> {
  ...
  Future<void> _onLocationUpdated(
    ...
    try {
      ...
      // Usar posición GPS real sin proyección a la polyline.
      // snapToPolyline desplazaba el marcador del usuario hacia la ruta
      // y causaba recálculos con origen incorrecto.
      final LatLng navigationLocation = rawLocation;
