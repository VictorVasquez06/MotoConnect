...
class _MapaCompartidoScreenState extends State<MapaCompartidoScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            tooltip: _centrarEnMi ? 'Desactivar seguimiento' : 'Activar seguimiento',
          ),
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              PopupMenuItem(
                ...
                child: Row(
                  children: [
                    Icon(_trackingActivo ? Icons.pause : Icons.play_arrow),
                    const SizedBox(width: 8),
                    Text(_trackingActivo ? 'Pausar tracking' : 'Reanudar tracking'),
                  ],
                ),
              ),
              const PopupMenuItem(
      ...
      floatingActionButton: _centrarEnMi
          ? null
    ...
    switch (value) {
      case 'pausa':
        if (_trackingActivo) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Tracking pausado')),
          );
        } else {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Tracking reanudado')),
          );
        }
        break;
