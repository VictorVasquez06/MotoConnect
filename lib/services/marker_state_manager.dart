...
class MarkerStateManager {
    ...
    final stateKey = isDisconnected
        ...
        : isPaused
            ...
            : isStale
                ? 'stale'
                : 'active';
    final cacheKey = '${userId}_$stateKey';
  ...
  Future<BitmapDescriptor> _createMarker({
    ...
    try {
      ...
      _enqueueRetry(cacheKey, userId, photoUrl, displayName, isPaused, isStale, isDisconnected);
  ...
  Future<void> _processRetryQueue() async {
    ...
    while (_retryQueue.isNotEmpty &&
      ...
      await _createMarker(
        ...
        isDisconnected: task.isDisconnected,
  ...
  Future<BitmapDescriptor> _buildMarkerIcon({
    ...
    try {
      ...
      // Fondo circular según estado: teal (activo), amber (stale), gris (pausado/desconectado)
